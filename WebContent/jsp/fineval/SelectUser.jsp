...
<% 
	...
	else
	{
		...
		String permission = finManager.reqUserPermission(loginId);
	
		if(permission.equals("평가담당자"))
		{
			response.sendRedirect("/ResearchMasterProject/jsp/fineval/ChargerFinEvalSelectProject.jsp");
		} // 과제책임자 일때 if 문 끝
		else if(permission.equals("평가위원장"))
		{
			response.sendRedirect("/ResearchMasterProject/jsp/fineval/ExpertFinEvalSelectProject.jsp");
		}
