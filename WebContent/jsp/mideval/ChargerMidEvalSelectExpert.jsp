...
function checkInput(chargerExpertList)
{
	...
	{
		document.chargerExpertList.action="/ResearchMasterProject/jsp/mideval/ChargerMidEvalAddPlan.jsp";
...
<%
	...
	expertList = midManager.requestExpertsForCharger(selProjectNum);
	
%>
<div id="contents">
	<form method="post" name="chargerExpertList" action="/ResearchMasterProject/jsp/mideval/ChargerMidEvalAddPlan.jsp">
		<table>
			<tr>
