...
function checkInput(chargerProjectList)
{
		...
		document.chargerProjectList.action="/ResearchMasterProject/jsp/mideval/ChargerMidEvalSelectExpert.jsp";
...
<% 
	...
	proList = midManager.requestProjectsForCharger();
	
%>
<div id="contents">
	<form method="post" name="chargerProjectList" action="/ResearchMasterProject/jsp/mideval/ChargerMidEvalSelectExpert.jsp">
		<%if(proList.size()==0){ %>
			<h2>등록승인된 프로젝트가 없습니다.</h2>
			<%}else{ %>
		<table>
			<tr>
