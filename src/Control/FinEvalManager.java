...
public class FinEvalManager {
	...
	public ArrayList<Project> requestProjectsForCharger()
	{
		...
		result = proManager.reqProjectList("상태", "정산완료");
		return result;
	}
	...
	public boolean requestAddFinEvalPlan(int projectNum, String expertLeaderId, String expertLeaderEmail, ArrayList<String> expertsEmail, String fileName, Date noticeDate)
	{
		//통보엑티브컨트롤.추가();
		//통보엑티브에 추가
		...
		FinEvalPlan addPlan = new FinEvalPlan(projectNum, expertLeaderId, expertLeaderEmail, 
	...
	public boolean requestAddFinEvalResult(int projectNum, String result, String fileName)
	{
		...
		//평가계획Entity에서 삭제();
		FinEvalPlanList planList = FinEvalPlanList.getInstance();
		planList.deleteFinEvalPlan(projectNum);
